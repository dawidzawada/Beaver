import { transformCameraTypeToCodeFormat } from "@domain/Code/utils/transformCameraTypeToCodeFormat";
...
export default function Scanner() {
  ...
  const onCodeScanned = (cameraCodes: CameraCode[]) => {
    ...
    if (firstCode !== "unknown") {
      const codeType = transformCameraTypeToCodeFormat(firstCode.type);
